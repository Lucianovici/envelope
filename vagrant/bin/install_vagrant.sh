...
APP_ROOT_DIR=${HOME_DIR}/envelope
...
function config_supervisor {
    ...
    cp /vagrant/supervisor/envelope.conf /etc/supervisor/conf.d/
    supervisorctl reread
    supervisorctl update
}

function start_gunicorn {
    checkpoint "Starting gunicorn with supervisor ..."
    supervisorctl start envelope
}
...
checkpoint "Your app is available via gunicorn and nginx."
